...
const CardProductPromotion: NextPage<Product> = ({
  ...
  return (
    <div className=" flex flex-col justify-between items-center m-2 p-1 border border-gray-300 rounded-lg shadow-md bg-white cursor-pointer min-w-[125px] max-w-[202px] h-[220px]">
      <img src={image} alt={name} className="object-cover flex mb-2 h-[45%] max-h-[50%] max-w-[80%]" />
